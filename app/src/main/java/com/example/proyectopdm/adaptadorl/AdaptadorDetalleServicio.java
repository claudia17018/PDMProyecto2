...
public class AdaptadorDetalleServicio extends  RecyclerView.Adapter<AdaptadorDetalleServicio.DetalleServicioViewHolder> implements  View.OnClickListener{
    BD helper;
    private ArrayList<DetalleServicio> listadoDetalleServicio;
    private Context context;
    private View.OnClickListener listener;


    public AdaptadorDetalleServicio(ArrayList<DetalleServicio> listadoDetalleServicio, Context context){
...
//TextView estadoDe, horasAs, beneI,beneD,observacionesD;
        ...
        holder.estadoDe.setText(String.valueOf(listadoDetalleServicio.get(position).getEstado()));
        holder.horasAs.setText(String.valueOf(listadoDetalleServicio.get(position).getHorasAsignadas()));
        holder.beneD.setText(String.valueOf(listadoDetalleServicio.get(position).getDirectos()));
        holder.beneI.setText(String.valueOf(listadoDetalleServicio.get(position).getIndirectos()));
        holder.observacionesD.setText(String.valueOf(listadoDetalleServicio.get(position).getObservaciones()));
        final DetalleServicio detalleServicio=listadoDetalleServicio.get(position);

        Bundle DetalleServicioEdit = new Bundle();
        DetalleServicioEdit.putParcelable("CARRERA",detalleServicio);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()){
                            case R.id.editBitacora:
                               ...
                               // Navigation.findNavController(view).navigate(R.id.editarCarreraFragment,DetalleServicioEdit);
                            ...
                            case R.id.deleteBitacora:
                                ...
                                builder.setPositiveButton(context.getString(R.string.buttonConfirm), new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        helper.abrir();
                                        helper.eliminarDetalleServicio(detalleServicio.getIdDetalle());
