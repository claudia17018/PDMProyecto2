...
public class AdaptadorResumenServicio extends  RecyclerView.Adapter<AdaptadorResumenServicio.ResumenServicioViewHolder> implements  View.OnClickListener{
        BD helper;
        private ArrayList<ResumenServicio> listadoResumenServicio;
        private  Context context;
        private View.OnClickListener listener;
        public int idResumenServicio;


    public AdaptadorResumenServicio(ArrayList<ResumenServicio> listadoResumenServicio, Context context){
    ...
    public void onBindViewHolder(AdaptadorResumenServicio.ResumenServicioViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.carnetR.setText(String.valueOf(listadoResumenServicio.get(position).getCarnetEs()));
        holder.tutorR.setText(String.valueOf(listadoResumenServicio.get(position).getDuiTu()));
        holder.fechaA.setText(String.valueOf(listadoResumenServicio.get(position).getFechaApertura()));
        holder.fechaC.setText(String.valueOf(listadoResumenServicio.get(position).getFechaCertificado()));
        final ResumenServicio resumenServicio=listadoResumenServicio.get(position);
